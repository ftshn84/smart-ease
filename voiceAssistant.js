...
// Example usage:
console.log(listToDo("Add fishing to my todo"));
// fishing added to your todo

console.log(listToDo("Add singing in the shower to my todo"));
// singing in the shower added to your todo

console.log(listToDo("Remove fishing from my todo"));
// Removed fishing from your todo

console.log(listToDo("What is on my todo?"));
